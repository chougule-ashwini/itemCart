...
folder `itemCart-snapshots`, which then contains an additional folder called `sandbox`.
...
- **snaphot.sh**: Run this script to generate the `itemCart-snapshots` folder, containing
